...
def seq_eval(cfg, loader, model, device, mode, epoch, work_dir, recoder,
    ...
    # gloss_filename1 = open('/home/gaoliqing/code_glq/CVPR_2022/context_csl-daily_contrastive/predict.txt','w')
    # gloss_filename = open('/home/gaoliqing/code_glq/CVPR_2022/context_csl-daily_contrastive/groundtruth.txt','w')
    # for i in range(len(txt_ref)):
    #     gloss_filename.write(txt_ref[i]+'\n')
    # for j in range(len(txt_hyp)):
    #     gloss_filename1.write(txt_hyp[j]+'\n')
    ...
    recoder.print_log(f"Epoch {epoch}, {mode} ", f"{work_dir}/{mode}.txt")
