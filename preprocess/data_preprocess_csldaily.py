...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='dialogue_csldaily',
                        help='save prefix')
    ...
    for md in mode:
        ...
        data_txt = f"../DatasetFile/dialogue_csldaily/{md}.txt"
        ...
        with open(data_txt) as f:
            if md == 'train':
                for i, line in enumerate(f.readlines()):
                    ...
                    information[i] = dict(folder=name,label=gloss,original_info=line)
            else:
                for i, line in enumerate(f.readlines()):
