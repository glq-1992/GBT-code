...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='dialogue_csl_split2_5000',
                        help='save prefix')
    ...
    for md in mode:
        ...
        data_txt = f"../DatasetFile/dialogue_csl_split2_5000/{md}.txt"
        information = {'prefix':args.dataset_root}
        with open(data_txt) as f:
            if md == 'train':
                for i, line in enumerate(f.readlines()):
                    line = line.replace('\n', '')
                    folder, label,text= line.split('Q')
