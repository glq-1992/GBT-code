...
from signjoey.transformer_layers import PositionalEncoding, TransformerDecoderLayer, TransformerDecoderLayer2Encoder, TransformerDecoderLayer3Encoder
...
class TransformerDecoder(Decoder):
    ...
    def forward(
        ...
        **kwargs
        ...
        # 由于与操作的广播，trg_mask的size为1，1，1也可以
...
class TransformerDecoder2Encoder(Decoder):
    """
    A transformer decoder with N masked layers.
    Decoder layers are masked so that an attention head cannot see the future.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param kwargs:
        """
        super(TransformerDecoder2Encoder, self).__init__()
        ...
        self.layers = nn.ModuleList(
            [
                TransformerDecoderLayer2Encoder(
                    size=hidden_size,
                    ff_size=ff_size,
                    num_heads=num_heads,
                    dropout=dropout,
    ...
    def forward(
        self,
        trg_embed: Tensor = None,
        encoder_output1: Tensor = None,
        encoder_output2: Tensor = None,
        encoder_hidden: Tensor = None,
        src_mask1: Tensor = None,
        ...
        **kwargs
        ...
        for layer in self.layers:
            x = layer(x=x, memory1=encoder_output1, memory2=encoder_output2, src_mask1=src_mask1, src_mask2=src_mask2, trg_mask=trg_mask)
            # x = layer(x=x, memory1=encoder_output1, src_mask1=src_mask1,
            #           trg_mask=trg_mask)
...
class TransformerDecoder3Encoder(Decoder):
    """
    A transformer decoder with N masked layers.
    Decoder layers are masked so that an attention head cannot see the future.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param kwargs:
        """
        super(TransformerDecoder3Encoder, self).__init__()
        ...
        self.layers = nn.ModuleList(
            [
                TransformerDecoderLayer3Encoder(
                    size=hidden_size,
                    ff_size=ff_size,
                    num_heads=num_heads,
                    dropout=dropout,
    ...
    def forward(
        ...
        encoder_output1: Tensor = None,
        encoder_output2: Tensor = None,
        encoder_output3: Tensor = None,
        encoder_hidden: Tensor = None,
        src_mask1: Tensor = None,
        src_mask2: Tensor = None,
        src_mask3: Tensor = None,
        unroll_steps: int = None,
        hidden: Tensor = None,
        trg_mask: Tensor = None,
        **kwargs
        ...
        for layer in self.layers:
            x = layer(x=x, memory1=encoder_output1, memory2=encoder_output2, memory3 = encoder_output3, src_mask1=src_mask1, src_mask2=src_mask2, src_mask3 = src_mask3, trg_mask=trg_mask)
