...
faulthandler.enable()
import utils
from seq_scripts_GSL_bert_text_nsp_slt_loss1 import seq_train, seq_eval, seq_feature_generation
...
if __name__ == '__main__':
    ...
    sparser = utils.parameters_phoenix_bert_sign_text_graph_slt.get_parser()
