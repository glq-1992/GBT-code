...
faulthandler.enable()
import utils
from seq_scripts_GSL_bert_text_nsp_slt_vg import seq_train, seq_eval, seq_feature_generation,seq_eval_slr #seq_scripts_GSL_bert_text_nsp_slt, 注释：seq_scripts_GSL_bert_text_nsp_slt_oneloss
...
if __name__ == '__main__':
    ...
    sparser = utils.parameters_csldaily_bert_sign_text_graph_slt.get_parser()
