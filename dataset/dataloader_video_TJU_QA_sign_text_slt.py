...
class BaseFeeder(data.Dataset):
    def __init__(self, prefix, gloss_dict, text_dict,tokenizer,drop_ratio=1, num_gloss=-1, mode="train", transform_mode=True,
        ...
        data_txt = f"/home/gaoliqing/code_glq/CVPR_2022/context_csl-daily_contrastive/DatasetFile/dialogue_tju_QA_eg_signer_slt/{mode}_slt_2p_contrastive.txt" #/home/gaoliqing/code_glq/CVPR_2022/context_csl-daily/slrBert  ,/home/gaoliqing/shipeng/code2/slt_qa_graph
        ...
        with open(data_txt) as f:
            for i,line in enumerate(f.readlines()):
                ...
                name, gloss, question, question_neg1, textLabel,question_neg2 = line.split('Q')
    ...
    def transform(self):
        if self.transform_mode == "train":
            ...
            return video_augmentation.Compose([
                # video_augmentation.CenterCrop(224),
                # video_augmentation.WERAugment('/lustre/wangtao/current_exp/exp/baseline/boundary.npy'),
                # video_augmentation.RandomCrop(180),
                video_augmentation.ResizeShape((224,224)), #180
                video_augmentation.RandomHorizontalFlip(0.5),
            ...
            return video_augmentation.Compose([
                ...
                # video_augmentation.CenterCrop(180),
                # video_augmentation.Resize(0.5),
                video_augmentation.ToTensor(),
            ])
