...
class BaseFeeder(data.Dataset):
    def __init__(self, prefix, gloss_dict, text_dict,tokenizer,drop_ratio=1, num_gloss=-1, mode="train", transform_mode=True,
        ...
        data_txt = f"/home/gaoliqing/code_glq/CVPR_2022/context_csl-daily_contrastive/DatasetFile/dialogue_csldaily_new/{mode}_char_contrastive.txt" #/home/gaoliqing/shipeng/code/slrBert,
